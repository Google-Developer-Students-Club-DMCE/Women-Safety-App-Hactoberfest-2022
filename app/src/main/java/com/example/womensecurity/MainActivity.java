...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            ...
            case R.id.share:
                // Issue #2
                // Add logic to share a playstore link of app to others
                // Put any random or dummy playstore link like: "https://play.google.com/store/apps/details?id=hi"
                break;
            case R.id.about:
                showAboutDialog();
                break;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.om_exit){
            // Issue #3
            // For Title get the string by using 'getString(R.string.Exit)'
            // For Message get the string by using 'getString(R.string.exit_message)'
            // Show 2 buttons: EXIT and CANCEL
            // Exit App if pressed EXIT
            // Close Dialog if pressed CANCEL
        }
